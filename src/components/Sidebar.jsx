...
export default function Sidebar({ bgColor = "#063955", showBack = false, onBack }) {
  ...
  if (isVertical) {
    return (
      <aside
        className="relative z-10 flex w-full shrink-0 items-center justify-between gap-[1.5rem] px-[2.25rem] py-[1.25rem] text-white"
      ...
      >
        <div className="flex items-center gap-[1.5rem]">
          <img
            ...
            draggable={false}
          />
          <img src={logo80} alt="80°" className="h-[3.5rem] w-auto" draggable={false} />
        </div>
        ...
        <div className="flex items-center gap-[1.25rem]">
          ...
          <div className="leading-[1]">
            <h1 className="text-[1.75rem] font-black">Nasce la Repubblica</h1>
            <p className="mt-[0.25rem] text-[1.25rem] font-medium">
